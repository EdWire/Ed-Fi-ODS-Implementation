...
COMMENT ON COLUMN tx.SectionSet.SPEDStudentAgeRangeDescriptorId IS 'E3059, C342. SPEDStudentAgeRange identifies the age range of Special Education students that teaching and paraprofessional staff provide services to.';
...
COMMENT ON TABLE tx.SPEDStudentAgeRangeDescriptor IS 'E3059. SPEDStudentAgeRange identifies the age range of Special Education students that teaching and paraprofessional staff provide services to.';
...
COMMENT ON COLUMN tx.StaffEducationOrganizationAssignmentAssociationStaffServiceSet.SPEDStudentAgeRangeDescriptorId IS 'E3059, C342. SPEDStudentAgeRange identifies the age range of Special Education students that teaching and paraprofessional staff provide services to.';
