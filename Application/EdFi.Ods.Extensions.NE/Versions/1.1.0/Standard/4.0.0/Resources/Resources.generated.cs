...
#pragma warning restore 414
        ...
        [Range(typeof(decimal), "-9.99", "9.99", ErrorMessage=ValidationHelpers.RangeMessageFormat)]
...
namespace EdFi.Ods.Api.Common.Models.Resources.CrisisDetails.NE
{
    /// <summary>
    /// Represents a reference to the CrisisDetails resource.
    /// </summary>
    [DataContract]
    [ExcludeFromCodeCoverage]
    public class CrisisDetailsReference : IResourceReference
    {
        [DataMember(Name="crisisEventDescriptor")][DescriptorExists("CrisisEventDescriptor")]
        ...
        {
            return CrisisEventDescriptor != default(string);
        }

        IEnumerable<string> IResourceReference.GetUndefinedProperties()
        {
            if (CrisisEventDescriptor == default)
            {
                yield return "CrisisEventDescriptor";
            }
    ...
    [Serializable, DataContract]
    [ExcludeFromCodeCoverage]
    public class CrisisDetails : Entities.Common.NE.ICrisisDetails, IHasETag, IDateVersionedEntity
    {
        private static FullName _fullName = new FullName("ne", "CrisisDetails");

        // Fluent validator instance (threadsafe)
        private static CrisisDetailsPutPostRequestValidator _validator = new CrisisDetailsPutPostRequestValidator();
...
#pragma warning restore 414
        ...
        /// <summary>
        /// The unique identifier for the CrisisDetails resource.
        /// </summary>
        [DataMember(Name="id")]
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.ICrisisDetails;
            ...
            // Standard Property
            if (!StringComparer.OrdinalIgnoreCase.Equals((this as Entities.Common.NE.ICrisisDetails).CrisisEventDescriptor, compareTo.CrisisEventDescriptor))
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            // Standard Property
                hash.Add((this as Entities.Common.NE.ICrisisDetails).CrisisEventDescriptor);
        ...
        [DataMember(Name="crisisDesription")]
        public string CrisisDesription { get; set; }

        /// <summary>
        /// First date that the crisis occurred
        /// </summary>
        // NOT in a reference, NOT a lookup column 
        [RequiredWithNonDefault]
        [DataMember(Name="crisisStartDate")][JsonConverter(typeof(Iso8601UtcDateOnlyConverter))]
        public DateTime CrisisStartDate { get; set; }

        /// <summary>
        /// The type of crisis event that occurred
        /// </summary>
        // NOT in a reference, IS a lookup column 
        [RequiredWithNonDefault]
        [NonDefaultStringLength(306, ErrorMessage=ValidationHelpers.StringLengthMessageFormat), NoDangerousText]
        [DataMember(Name="crisisTypeDescriptor")][DescriptorExists("CrisisTypeDescriptor")]
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.CrisisDetailsMapper.SynchronizeTo(this, (Entities.Common.NE.ICrisisDetails)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.CrisisDetailsMapper.MapTo(this, (Entities.Common.NE.ICrisisDetails)target, null);
        }
        // -------------------------------------------------------------
    ...
    [ExcludeFromCodeCoverage]
    public class CrisisDetailsPutPostRequestValidator : FluentValidation.AbstractValidator<CrisisDetails>
    {
        protected override bool PreValidate(FluentValidation.ValidationContext<CrisisDetails> context, FluentValidation.Results.ValidationResult result)
        {
            if (context.InstanceToValidate == null)
            {
                result.Errors.Add(new ValidationFailure("", "Please ensure a model was supplied."));
...
namespace EdFi.Ods.Api.Common.Models.Resources.CrisisEventDescriptor.NE
{
    /// <summary>
    ...
    [Serializable, DataContract]
    [ExcludeFromCodeCoverage]
    public class CrisisEventDescriptor : Entities.Common.NE.ICrisisEventDescriptor, Entities.Common.EdFi.IDescriptor, IHasETag, IDateVersionedEntity
    {
        private static FullName _fullName = new FullName("ne", "CrisisEventDescriptor");

        // Fluent validator instance (threadsafe)
        private static CrisisEventDescriptorPutPostRequestValidator _validator = new CrisisEventDescriptorPutPostRequestValidator();
...
#pragma warning restore 414
        ...
        /// <summary>
        /// The unique identifier for the CrisisEventDescriptor resource.
        /// </summary>
        [DataMember(Name="id")]
        [JsonConverter(typeof(GuidConverter))]
        public Guid Id { get; set; }
        ...
        {
            get { return CrisisEventDescriptorId; }
            set { CrisisEventDescriptorId = value; }
        }
        // -------------------------------------------------------------
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.ICrisisEventDescriptor;
            ...
            // Derived Property
            if (!(this as Entities.Common.NE.ICrisisEventDescriptor).CrisisEventDescriptorId.Equals(compareTo.CrisisEventDescriptorId))
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            //Derived Property
            hash.Add((this as Entities.Common.NE.ICrisisEventDescriptor).CrisisEventDescriptorId);
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.CrisisEventDescriptorMapper.SynchronizeTo(this, (Entities.Common.NE.ICrisisEventDescriptor)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.CrisisEventDescriptorMapper.MapTo(this, (Entities.Common.NE.ICrisisEventDescriptor)target, null);
        }
        // -------------------------------------------------------------
    ...
    [ExcludeFromCodeCoverage]
    public class CrisisEventDescriptorPutPostRequestValidator : FluentValidation.AbstractValidator<CrisisEventDescriptor>
    {
        protected override bool PreValidate(FluentValidation.ValidationContext<CrisisEventDescriptor> context, FluentValidation.Results.ValidationResult result)
        {
            if (context.InstanceToValidate == null)
            {
                result.Errors.Add(new ValidationFailure("", "Please ensure a model was supplied."));
...
namespace EdFi.Ods.Api.Common.Models.Resources.CrisisTypeDescriptor.NE
{
    /// <summary>
    ...
    [Serializable, DataContract]
    [ExcludeFromCodeCoverage]
    public class CrisisTypeDescriptor : Entities.Common.NE.ICrisisTypeDescriptor, Entities.Common.EdFi.IDescriptor, IHasETag, IDateVersionedEntity
    {
        private static FullName _fullName = new FullName("ne", "CrisisTypeDescriptor");

        // Fluent validator instance (threadsafe)
        private static CrisisTypeDescriptorPutPostRequestValidator _validator = new CrisisTypeDescriptorPutPostRequestValidator();
...
#pragma warning restore 414
        ...
        /// <summary>
        /// The unique identifier for the CrisisTypeDescriptor resource.
        /// </summary>
        [DataMember(Name="id")]
        [JsonConverter(typeof(GuidConverter))]
        public Guid Id { get; set; }
        ...
        int IDescriptor.DescriptorId
        {
            get { return CrisisTypeDescriptorId; }
            set { CrisisTypeDescriptorId = value; }
        }
        // -------------------------------------------------------------
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.ICrisisTypeDescriptor;
            ...
            // Derived Property
            if (!(this as Entities.Common.NE.ICrisisTypeDescriptor).CrisisTypeDescriptorId.Equals(compareTo.CrisisTypeDescriptorId))
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            //Derived Property
            hash.Add((this as Entities.Common.NE.ICrisisTypeDescriptor).CrisisTypeDescriptorId);
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.CrisisTypeDescriptorMapper.SynchronizeTo(this, (Entities.Common.NE.ICrisisTypeDescriptor)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.CrisisTypeDescriptorMapper.MapTo(this, (Entities.Common.NE.ICrisisTypeDescriptor)target, null);
        }
        // -------------------------------------------------------------
    ...
    [ExcludeFromCodeCoverage]
    public class CrisisTypeDescriptorPutPostRequestValidator : FluentValidation.AbstractValidator<CrisisTypeDescriptor>
    {
        protected override bool PreValidate(FluentValidation.ValidationContext<CrisisTypeDescriptor> context, FluentValidation.Results.ValidationResult result)
        {
            if (context.InstanceToValidate == null)
            {
                result.Errors.Add(new ValidationFailure("", "Please ensure a model was supplied."));
...
namespace EdFi.Ods.Api.Common.Models.Resources.DualCreditDescriptor.NE
{
    /// <summary>
    ...
    [Serializable, DataContract]
    [ExcludeFromCodeCoverage]
    public class DualCreditDescriptor : Entities.Common.NE.IDualCreditDescriptor, Entities.Common.EdFi.IDescriptor, IHasETag, IDateVersionedEntity
    {
        private static FullName _fullName = new FullName("ne", "DualCreditDescriptor");

        // Fluent validator instance (threadsafe)
        private static DualCreditDescriptorPutPostRequestValidator _validator = new DualCreditDescriptorPutPostRequestValidator();
...
#pragma warning restore 414
        ...
        /// <summary>
        /// The unique identifier for the DualCreditDescriptor resource.
        /// </summary>
        [DataMember(Name="id")]
        [JsonConverter(typeof(GuidConverter))]
        public Guid Id { get; set; }
        ...
        int IDescriptor.DescriptorId
        {
            get { return DualCreditDescriptorId; }
            set { DualCreditDescriptorId = value; }
        }
        // -------------------------------------------------------------
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.IDualCreditDescriptor;
            ...
            // Derived Property
            if (!(this as Entities.Common.NE.IDualCreditDescriptor).DualCreditDescriptorId.Equals(compareTo.DualCreditDescriptorId))
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            //Derived Property
            hash.Add((this as Entities.Common.NE.IDualCreditDescriptor).DualCreditDescriptorId);
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.DualCreditDescriptorMapper.SynchronizeTo(this, (Entities.Common.NE.IDualCreditDescriptor)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.DualCreditDescriptorMapper.MapTo(this, (Entities.Common.NE.IDualCreditDescriptor)target, null);
        }
        // -------------------------------------------------------------
    ...
    [ExcludeFromCodeCoverage]
    public class DualCreditDescriptorPutPostRequestValidator : FluentValidation.AbstractValidator<DualCreditDescriptor>
    {
        protected override bool PreValidate(FluentValidation.ValidationContext<DualCreditDescriptor> context, FluentValidation.Results.ValidationResult result)
        {
            if (context.InstanceToValidate == null)
            {
                result.Errors.Add(new ValidationFailure("", "Please ensure a model was supplied."));
...
namespace EdFi.Ods.Api.Common.Models.Resources.PostGraduateActivity.NE
{
    ...
    public class PostGraduateActivityReference : IResourceReference
    {
        ...
        public bool IsReferenceFullyDefined()
        {
            return LocalEducationAgencyId != default(int) && SchoolYear != default(short) && StudentUniqueId != default(string);
        }
...
#pragma warning restore 414
        ...
        int Entities.Common.NE.IPostGraduateActivity.LocalEducationAgencyId
        {
            get
            {
                if (ImplicitLocalEducationAgencyReference != null
...
#pragma warning restore 414
        ...
        {
            StudentDisciplineIncidentBehaviorAssociationWeapons = new List<StudentDisciplineIncidentBehaviorAssociationWeapon>();
        }
        ...
        //                          Collections
        // -------------------------------------------------------------
        private ICollection<StudentDisciplineIncidentBehaviorAssociationWeapon> _studentDisciplineIncidentBehaviorAssociationWeapons;
        private ICollection<Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon> _studentDisciplineIncidentBehaviorAssociationWeaponsCovariant;

        [NoDuplicateMembers]
        [DataMember(Name="weapons")]
        public ICollection<StudentDisciplineIncidentBehaviorAssociationWeapon> StudentDisciplineIncidentBehaviorAssociationWeapons
        {
            get { return _studentDisciplineIncidentBehaviorAssociationWeapons; }
            set
            {
                if (value == null) return;
                // Initialize primary list with notifying adapter immediately wired up so existing items are associated with the parent
                var list = new CollectionAdapterWithAddNotifications<StudentDisciplineIncidentBehaviorAssociationWeapon>(value,
                    (s, e) => ((Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon)e.Item).StudentDisciplineIncidentBehaviorAssociationExtension = this);
                _studentDisciplineIncidentBehaviorAssociationWeapons = list;

                // Initialize covariant list with notifying adapter with deferred wire up so only new items are processed (optimization)
                var covariantList = new CovariantCollectionAdapterWithAddNotifications<Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon, StudentDisciplineIncidentBehaviorAssociationWeapon>(value);
                covariantList.ItemAdded += (s, e) => ((Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon)e.Item).StudentDisciplineIncidentBehaviorAssociationExtension = this;
                _studentDisciplineIncidentBehaviorAssociationWeaponsCovariant = covariantList;
            }
        }

        // Covariant version, visible only on the interface
        ICollection<Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon> Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationExtension.StudentDisciplineIncidentBehaviorAssociationWeapons
        {
            get { return _studentDisciplineIncidentBehaviorAssociationWeaponsCovariant; }
            set { StudentDisciplineIncidentBehaviorAssociationWeapons = new List<StudentDisciplineIncidentBehaviorAssociationWeapon>(value.Cast<StudentDisciplineIncidentBehaviorAssociationWeapon>()); }
        }
        ...
        {
            // Reconnect collection item parent references on deserialization
            if (_studentDisciplineIncidentBehaviorAssociationWeapons != null) foreach (var item in _studentDisciplineIncidentBehaviorAssociationWeapons)
            {
                item.StudentDisciplineIncidentBehaviorAssociationExtension = this;
            }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                //  Validate collections
                // ----------------------
                if (StudentDisciplineIncidentBehaviorAssociationWeapons.Any() && mappingContract?.IsMemberSupported("StudentDisciplineIncidentBehaviorAssociationWeapons") != false)
                {
                    // Reset path builder
                    pathBuilder.Length = dotLength;
                    pathBuilder.Append("StudentDisciplineIncidentBehaviorAssociationWeapons");
    
                    foreach (var result in ValidationHelpers.ValidateCollection(new ValidationContext(StudentDisciplineIncidentBehaviorAssociationWeapons, validationContext, validationContext.Items.ForCollection("StudentDisciplineIncidentBehaviorAssociationWeapons"))))
                    {
                        yield return result;
                    }
                }
    ...
    public class StudentDisciplineIncidentBehaviorAssociationExtensionPutPostRequestValidator : FluentValidation.AbstractValidator<StudentDisciplineIncidentBehaviorAssociationExtension>
    {
        ...
        // Declare collection item validators
        private StudentDisciplineIncidentBehaviorAssociationWeaponPutPostRequestValidator _studentDisciplineIncidentBehaviorAssociationWeaponsValidator = new ();
        ...
        protected override bool PreValidate(FluentValidation.ValidationContext<StudentDisciplineIncidentBehaviorAssociationExtension> context, FluentValidation.Results.ValidationResult result)
        {
            ...
            // Get the current mapping contract
            var mappingContract = (global::EdFi.Ods.Entities.Common.NE.StudentDisciplineIncidentBehaviorAssociationExtensionMappingContract) GeneratedArtifactStaticDependencies.MappingContractProvider
                .GetMappingContract(_fullName_ne_StudentDisciplineIncidentBehaviorAssociationExtension);

            if (mappingContract != null)
            {
                if (mappingContract.IsStudentDisciplineIncidentBehaviorAssociationWeaponIncluded != null)
                {
                    var hasInvalidStudentDisciplineIncidentBehaviorAssociationWeaponsItems = instance.StudentDisciplineIncidentBehaviorAssociationWeapons.Any(x => !mappingContract.IsStudentDisciplineIncidentBehaviorAssociationWeaponIncluded(x));
        
                    if (hasInvalidStudentDisciplineIncidentBehaviorAssociationWeaponsItems)
                    {
                        profileName ??= GeneratedArtifactStaticDependencies.ProfileContentTypeContextProvider.Get().ProfileName;
                        failures.Add(new ValidationFailure("StudentDisciplineIncidentBehaviorAssociationWeapons", $"A supplied 'StudentDisciplineIncidentBehaviorAssociationWeapon' has a descriptor value that does not conform with the filter values defined by profile '{profileName}'."));
                    }
                }
    ...
    [Serializable, DataContract]
    [ExcludeFromCodeCoverage]
    public class StudentDisciplineIncidentBehaviorAssociationWeapon : Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon
    {
        private static FullName _fullName = new FullName("ne", "StudentDisciplineIncidentBehaviorAssociationWeapon");

        // Fluent validator instance (threadsafe)
        private static StudentDisciplineIncidentBehaviorAssociationWeaponPutPostRequestValidator _validator = new StudentDisciplineIncidentBehaviorAssociationWeaponPutPostRequestValidator();
...
#pragma warning restore 414
        ...
        //                         Primary Key
        // -------------------------------------------------------------
        private Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationExtension _studentDisciplineIncidentBehaviorAssociationExtension;

        [IgnoreDataMember]
        Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationExtension Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon.StudentDisciplineIncidentBehaviorAssociationExtension
        {
            get { return _studentDisciplineIncidentBehaviorAssociationExtension; }
            set { SetStudentDisciplineIncidentBehaviorAssociationExtension(value); }
        }

        public Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationExtension StudentDisciplineIncidentBehaviorAssociationExtension
        {
            set { SetStudentDisciplineIncidentBehaviorAssociationExtension(value); }
        }

        private void SetStudentDisciplineIncidentBehaviorAssociationExtension(Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationExtension value)
        {
            _studentDisciplineIncidentBehaviorAssociationExtension = value;
        }
        ...
        [RequiredWithNonDefault]
        [NonDefaultStringLength(306, ErrorMessage=ValidationHelpers.StringLengthMessageFormat), NoDangerousText, NoWhitespace]
        [DataMember(Name="weaponDescriptor")][DescriptorExists("WeaponDescriptor")]
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon;
            ...
            // Parent Property
            if (_studentDisciplineIncidentBehaviorAssociationExtension == null || !_studentDisciplineIncidentBehaviorAssociationExtension.Equals(compareTo.StudentDisciplineIncidentBehaviorAssociationExtension))
                return false;


            // Standard Property
            if (!StringComparer.OrdinalIgnoreCase.Equals((this as Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon).WeaponDescriptor, compareTo.WeaponDescriptor))
                return false;
        ...
        public override int GetHashCode()
        {
            var hash = new HashCode();
            //Parent Property
            if (_studentDisciplineIncidentBehaviorAssociationExtension != null)
                hash.Add(_studentDisciplineIncidentBehaviorAssociationExtension);

            // Standard Property
                hash.Add((this as Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon).WeaponDescriptor);
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.StudentDisciplineIncidentBehaviorAssociationWeaponMapper.SynchronizeTo(this, (Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.StudentDisciplineIncidentBehaviorAssociationWeaponMapper.MapTo(this, (Entities.Common.NE.IStudentDisciplineIncidentBehaviorAssociationWeapon)target, null);
        }
        // -------------------------------------------------------------
    ...
    [ExcludeFromCodeCoverage]
    public class StudentDisciplineIncidentBehaviorAssociationWeaponPutPostRequestValidator : FluentValidation.AbstractValidator<StudentDisciplineIncidentBehaviorAssociationWeapon>
    {
        protected override bool PreValidate(FluentValidation.ValidationContext<StudentDisciplineIncidentBehaviorAssociationWeapon> context, FluentValidation.Results.ValidationResult result)
        {
            if (context.InstanceToValidate == null)
            {
                result.Errors.Add(new ValidationFailure("", "Please ensure a model was supplied."));
...
#pragma warning restore 414
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                //  Validate embedded objects
                // ---------------------------
                if (GeneralStudentProgramAssociationParticipationStatus != null)
                {
                    // Reset path builder
                    pathBuilder.Length = dotLength;
...
#pragma warning restore 414
        ...
        {
            StudentEducationOrganizationAssociationStudentCrisisEvents = new List<StudentEducationOrganizationAssociationStudentCrisisEvent>();
        }
        ...
        //                          Collections
        // -------------------------------------------------------------
        private ICollection<StudentEducationOrganizationAssociationStudentCrisisEvent> _studentEducationOrganizationAssociationStudentCrisisEvents;
        private ICollection<Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent> _studentEducationOrganizationAssociationStudentCrisisEventsCovariant;

        [NoDuplicateMembers]
        [DataMember(Name="studentCrisisEvents")]
        public ICollection<StudentEducationOrganizationAssociationStudentCrisisEvent> StudentEducationOrganizationAssociationStudentCrisisEvents
        {
            get { return _studentEducationOrganizationAssociationStudentCrisisEvents; }
            set
            {
                if (value == null) return;
                // Initialize primary list with notifying adapter immediately wired up so existing items are associated with the parent
                var list = new CollectionAdapterWithAddNotifications<StudentEducationOrganizationAssociationStudentCrisisEvent>(value,
                    (s, e) => ((Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent)e.Item).StudentEducationOrganizationAssociationExtension = this);
                _studentEducationOrganizationAssociationStudentCrisisEvents = list;

                // Initialize covariant list with notifying adapter with deferred wire up so only new items are processed (optimization)
                var covariantList = new CovariantCollectionAdapterWithAddNotifications<Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent, StudentEducationOrganizationAssociationStudentCrisisEvent>(value);
                covariantList.ItemAdded += (s, e) => ((Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent)e.Item).StudentEducationOrganizationAssociationExtension = this;
                _studentEducationOrganizationAssociationStudentCrisisEventsCovariant = covariantList;
            }
        }

        // Covariant version, visible only on the interface
        ICollection<Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent> Entities.Common.NE.IStudentEducationOrganizationAssociationExtension.StudentEducationOrganizationAssociationStudentCrisisEvents
        {
            get { return _studentEducationOrganizationAssociationStudentCrisisEventsCovariant; }
            set { StudentEducationOrganizationAssociationStudentCrisisEvents = new List<StudentEducationOrganizationAssociationStudentCrisisEvent>(value.Cast<StudentEducationOrganizationAssociationStudentCrisisEvent>()); }
        }
        ...
        {
            // Reconnect collection item parent references on deserialization
            if (_studentEducationOrganizationAssociationStudentCrisisEvents != null) foreach (var item in _studentEducationOrganizationAssociationStudentCrisisEvents)
            {
                item.StudentEducationOrganizationAssociationExtension = this;
            }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            try
            {
                ...
                //  Validate collections
                // ----------------------
                if (StudentEducationOrganizationAssociationStudentCrisisEvents.Any() && mappingContract?.IsMemberSupported("StudentEducationOrganizationAssociationStudentCrisisEvents") != false)
                {
                    // Reset path builder
                    pathBuilder.Length = dotLength;
                    pathBuilder.Append("StudentEducationOrganizationAssociationStudentCrisisEvents");
    
                    foreach (var result in ValidationHelpers.ValidateCollection(new ValidationContext(StudentEducationOrganizationAssociationStudentCrisisEvents, validationContext, validationContext.Items.ForCollection("StudentEducationOrganizationAssociationStudentCrisisEvents"))))
                    {
                        yield return result;
                    }
                }
    ...
    public class StudentEducationOrganizationAssociationExtensionPutPostRequestValidator : FluentValidation.AbstractValidator<StudentEducationOrganizationAssociationExtension>
    {
        ...
        // Declare collection item validators
        private StudentEducationOrganizationAssociationStudentCrisisEventPutPostRequestValidator _studentEducationOrganizationAssociationStudentCrisisEventsValidator = new ();
        ...
        protected override bool PreValidate(FluentValidation.ValidationContext<StudentEducationOrganizationAssociationExtension> context, FluentValidation.Results.ValidationResult result)
        {
            ...
            // Get the current mapping contract
            var mappingContract = (global::EdFi.Ods.Entities.Common.NE.StudentEducationOrganizationAssociationExtensionMappingContract) GeneratedArtifactStaticDependencies.MappingContractProvider
                .GetMappingContract(_fullName_ne_StudentEducationOrganizationAssociationExtension);

            if (mappingContract != null)
            {
                if (mappingContract.IsStudentEducationOrganizationAssociationStudentCrisisEventIncluded != null)
                {
                    var hasInvalidStudentEducationOrganizationAssociationStudentCrisisEventsItems = instance.StudentEducationOrganizationAssociationStudentCrisisEvents.Any(x => !mappingContract.IsStudentEducationOrganizationAssociationStudentCrisisEventIncluded(x));
        
                    if (hasInvalidStudentEducationOrganizationAssociationStudentCrisisEventsItems)
                    {
                        profileName ??= GeneratedArtifactStaticDependencies.ProfileContentTypeContextProvider.Get().ProfileName;
                        failures.Add(new ValidationFailure("StudentEducationOrganizationAssociationStudentCrisisEvents", $"A supplied 'StudentEducationOrganizationAssociationStudentCrisisEvent' has a descriptor value that does not conform with the filter values defined by profile '{profileName}'."));
                    }
                }
    ...
    [ExcludeFromCodeCoverage]
    [NoUnsuppliedRequiredMembersWithMeaningfulDefaults]
    public class StudentEducationOrganizationAssociationStudentCrisisEvent : Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent, IHasRequiredMembersWithMeaningfulDefaultValues
    {
        private static FullName _fullName = new FullName("ne", "StudentEducationOrganizationAssociationStudentCrisisEvent");

        // Fluent validator instance (threadsafe)
        private static StudentEducationOrganizationAssociationStudentCrisisEventPutPostRequestValidator _validator = new StudentEducationOrganizationAssociationStudentCrisisEventPutPostRequestValidator();
...
#pragma warning restore 414
        ...
        //                         Primary Key
        // -------------------------------------------------------------
        private Entities.Common.NE.IStudentEducationOrganizationAssociationExtension _studentEducationOrganizationAssociationExtension;

        [IgnoreDataMember]
        Entities.Common.NE.IStudentEducationOrganizationAssociationExtension Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent.StudentEducationOrganizationAssociationExtension
        {
            get { return _studentEducationOrganizationAssociationExtension; }
            set { SetStudentEducationOrganizationAssociationExtension(value); }
        }

        public Entities.Common.NE.IStudentEducationOrganizationAssociationExtension StudentEducationOrganizationAssociationExtension
        {
            set { SetStudentEducationOrganizationAssociationExtension(value); }
        }

        private void SetStudentEducationOrganizationAssociationExtension(Entities.Common.NE.IStudentEducationOrganizationAssociationExtension value)
        {
            _studentEducationOrganizationAssociationExtension = value;
        }
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent;
            ...
            // Parent Property
            if (_studentEducationOrganizationAssociationExtension == null || !_studentEducationOrganizationAssociationExtension.Equals(compareTo.StudentEducationOrganizationAssociationExtension))
                return false;


            // Standard Property
            if (!StringComparer.OrdinalIgnoreCase.Equals((this as Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent).CrisisEventDescriptor, compareTo.CrisisEventDescriptor))
                return false;
        ...
        public override int GetHashCode()
        {
            var hash = new HashCode();
            //Parent Property
            if (_studentEducationOrganizationAssociationExtension != null)
                hash.Add(_studentEducationOrganizationAssociationExtension);

            // Standard Property
                hash.Add((this as Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent).CrisisEventDescriptor);
        ...
        private bool _displacedStudentIndicatorExplicitlyAssigned = false;
        private bool _displacedStudentIndicator;
        ...
        /// </summary>
        // NOT in a reference, NOT a lookup column 
        [DataMember(Name="displacedStudentIndicator")]
        public bool DisplacedStudentIndicator 
        { 
            get => _displacedStudentIndicator;
            set 
            { 
                _displacedStudentIndicator = value;
                _displacedStudentIndicatorExplicitlyAssigned = true; 
            }
        }
        ...
        IEnumerable<string> IHasRequiredMembersWithMeaningfulDefaultValues.GetUnassignedMemberNames()
        {
            if (!_displacedStudentIndicatorExplicitlyAssigned)
            {
                yield return "DisplacedStudentIndicator";
            }
        }
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.StudentEducationOrganizationAssociationStudentCrisisEventMapper.SynchronizeTo(this, (Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.StudentEducationOrganizationAssociationStudentCrisisEventMapper.MapTo(this, (Entities.Common.NE.IStudentEducationOrganizationAssociationStudentCrisisEvent)target, null);
        }
        // -------------------------------------------------------------
    ...
    [ExcludeFromCodeCoverage]
    public class StudentEducationOrganizationAssociationStudentCrisisEventPutPostRequestValidator : FluentValidation.AbstractValidator<StudentEducationOrganizationAssociationStudentCrisisEvent>
    {
        protected override bool PreValidate(FluentValidation.ValidationContext<StudentEducationOrganizationAssociationStudentCrisisEvent> context, FluentValidation.Results.ValidationResult result)
        {
            if (context.InstanceToValidate == null)
            {
                result.Errors.Add(new ValidationFailure("", "Please ensure a model was supplied."));
...
#pragma warning restore 414
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int? Entities.Common.NE.IStudentSchoolAssociationExtension.ExpectedHighSchoolOfGraduationSchoolId
        {
            get
            {
                if (ImplicitExpectedHighSchoolOfGraduationSchoolReference != null
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int Entities.Common.NE.IStudentSchoolAssociationExtension.ReportingSchoolId
        {
            get
            {
                if (ImplicitReportingSchoolReference != null
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int Entities.Common.NE.IStudentSchoolAssociationExtension.ResidentLocalEducationAgencyId
        {
            get
            {
                if (ImplicitResidentLocalEducationAgencyReference != null
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int? Entities.Common.NE.IStudentSchoolAssociationExtension.ResidentSchoolId
        {
            get
            {
                if (ImplicitResidentSchoolReference != null
...
namespace EdFi.Ods.Api.Common.Models.Resources.StudentSectionAssociation.EdFi.Extensions.NE
{
    /// <summary>
...
#pragma warning restore 414
        ...
        [IgnoreDataMember]
        Entities.Common.EdFi.IStudentSectionAssociation Entities.Common.NE.IStudentSectionAssociationExtension.StudentSectionAssociation
        {
        ...
        public override bool Equals(object obj)
        {
            var compareTo = obj as Entities.Common.NE.IStudentSectionAssociationExtension;
        ...
        /// <summary>
        /// To indicate if student earned both high school and postsecondary credit for this course.
        /// </summary>
        // NOT in a reference, IS a lookup column 
        [NonDefaultStringLength(306, ErrorMessage=ValidationHelpers.StringLengthMessageFormat), NoDangerousText]
        [DataMember(Name="dualCreditDescriptor")][DescriptorExists("DualCreditDescriptor")]
        public string DualCreditDescriptor { get; set; }
        // -------------------------------------------------------------
        ...
        bool ISynchronizable.Synchronize(object target)
        {
            return Entities.Common.NE.StudentSectionAssociationExtensionMapper.SynchronizeTo(this, (Entities.Common.NE.IStudentSectionAssociationExtension)target);
        }

        void IMappable.Map(object target)
        {
            Entities.Common.NE.StudentSectionAssociationExtensionMapper.MapTo(this, (Entities.Common.NE.IStudentSectionAssociationExtension)target, null);
        }
        // -------------------------------------------------------------
