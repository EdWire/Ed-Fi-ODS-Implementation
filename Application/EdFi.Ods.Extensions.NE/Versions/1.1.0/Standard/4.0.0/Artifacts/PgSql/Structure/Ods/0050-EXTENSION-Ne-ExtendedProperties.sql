...
COMMENT ON COLUMN ne.StudentDisciplineIncidentBehaviorAssociationExtension.SchoolId IS 'The identifier assigned to a school.';
...
COMMENT ON TABLE ne.StudentDisciplineIncidentBehaviorAssociationWeapon IS 'Identifies the type of weapon used during an incident.';
COMMENT ON COLUMN ne.StudentDisciplineIncidentBehaviorAssociationWeapon.BehaviorDescriptorId IS 'Describes behavior by category.';
COMMENT ON COLUMN ne.StudentDisciplineIncidentBehaviorAssociationWeapon.IncidentIdentifier IS 'A locally assigned unique identifier (within the school or school district) to identify each specific DisciplineIncident or occurrence. The same identifier should be used to document the entire discipline incident even if it included multiple offenses and multiple offenders.';
COMMENT ON COLUMN ne.StudentDisciplineIncidentBehaviorAssociationWeapon.SchoolId IS 'The identifier assigned to a school.';
COMMENT ON COLUMN ne.StudentDisciplineIncidentBehaviorAssociationWeapon.StudentUSI IS 'A unique alphanumeric code assigned to a student.';
COMMENT ON COLUMN ne.StudentDisciplineIncidentBehaviorAssociationWeapon.WeaponDescriptorId IS 'Identifies the type of weapon used during an incident.';
...
COMMENT ON COLUMN ne.StudentSchoolAssociationExtension.ExpectedHighSchoolOfGraduationSchoolId IS 'The identifier assigned to a school.';
...
COMMENT ON COLUMN ne.StudentSectionAssociationExtension.SessionName IS 'The identifier for the calendar for the academic session.';
