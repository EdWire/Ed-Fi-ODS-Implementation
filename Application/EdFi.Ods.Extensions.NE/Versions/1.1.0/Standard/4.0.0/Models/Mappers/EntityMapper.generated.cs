...
namespace EdFi.Ods.Entities.Common.NE //.CrisisDetailsAggregate
{
    [ExcludeFromCodeCoverage]
    public static class CrisisDetailsMapper
    {
        private static readonly FullName _fullName_ne_CrisisDetails = new FullName("ne", "CrisisDetails");
    
        public static bool SynchronizeTo(this ICrisisDetails source, ICrisisDetails target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (CrisisDetailsMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_CrisisDetails);

            // Detect primary key changes
            if (
                 !string.Equals(target.CrisisEventDescriptor, source.CrisisEventDescriptor, StringComparison.OrdinalIgnoreCase))
            {
                // Disallow PK column updates on CrisisDetails
                throw new KeyChangeNotSupportedException("CrisisDetails");
            }


            // Copy non-PK properties

            if ((mappingContract?.IsCrisisDesriptionSupported != false)
                && target.CrisisDesription != source.CrisisDesription)
            {
                target.CrisisDesription = source.CrisisDesription;
                isModified = true;
            }

            if ((mappingContract?.IsCrisisStartDateSupported != false)
                && target.CrisisStartDate != source.CrisisStartDate)
            {
                target.CrisisStartDate = source.CrisisStartDate;
                isModified = true;
            }

            if ((mappingContract?.IsCrisisTypeDescriptorSupported != false)
                && target.CrisisTypeDescriptor != source.CrisisTypeDescriptor)
            {
                target.CrisisTypeDescriptor = source.CrisisTypeDescriptor;
                isModified = true;
            }
        ...
        public static void MapTo(this ICrisisDetails source, ICrisisDetails target, Action<ICrisisDetails, ICrisisDetails> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (CrisisDetailsMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            // Copy contextual primary key values
            target.CrisisEventDescriptor = source.CrisisEventDescriptor;
...
namespace EdFi.Ods.Entities.Common.NE //.CrisisEventDescriptorAggregate
{
    [ExcludeFromCodeCoverage]
    public static class CrisisEventDescriptorMapper
    {
        private static readonly FullName _fullName_ne_CrisisEventDescriptor = new FullName("ne", "CrisisEventDescriptor");
    
        public static bool SynchronizeTo(this ICrisisEventDescriptor source, ICrisisEventDescriptor target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (CrisisEventDescriptorMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_CrisisEventDescriptor);
            ...
            {
                // Disallow PK column updates on CrisisEventDescriptor
                throw new KeyChangeNotSupportedException("CrisisEventDescriptor");
            }
        ...
        public static void MapTo(this ICrisisEventDescriptor source, ICrisisEventDescriptor target, Action<ICrisisEventDescriptor, ICrisisEventDescriptor> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (CrisisEventDescriptorMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            // Copy contextual primary key values
            target.CrisisEventDescriptorId = source.CrisisEventDescriptorId;
...
namespace EdFi.Ods.Entities.Common.NE //.CrisisTypeDescriptorAggregate
{
    [ExcludeFromCodeCoverage]
    public static class CrisisTypeDescriptorMapper
    {
        private static readonly FullName _fullName_ne_CrisisTypeDescriptor = new FullName("ne", "CrisisTypeDescriptor");
    
        public static bool SynchronizeTo(this ICrisisTypeDescriptor source, ICrisisTypeDescriptor target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (CrisisTypeDescriptorMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_CrisisTypeDescriptor);
            ...
            if (
                ...
                || !string.Equals(target.CodeValue, source.CodeValue, StringComparison.OrdinalIgnoreCase))
            {
                // Disallow PK column updates on CrisisTypeDescriptor
                throw new KeyChangeNotSupportedException("CrisisTypeDescriptor");
            }
        ...
        public static void MapTo(this ICrisisTypeDescriptor source, ICrisisTypeDescriptor target, Action<ICrisisTypeDescriptor, ICrisisTypeDescriptor> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (CrisisTypeDescriptorMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
...
namespace EdFi.Ods.Entities.Common.NE //.DualCreditDescriptorAggregate
{
    [ExcludeFromCodeCoverage]
    public static class DualCreditDescriptorMapper
    {
        private static readonly FullName _fullName_ne_DualCreditDescriptor = new FullName("ne", "DualCreditDescriptor");
    
        public static bool SynchronizeTo(this IDualCreditDescriptor source, IDualCreditDescriptor target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (DualCreditDescriptorMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_DualCreditDescriptor);
            ...
            if (
                ...
                || !string.Equals(target.CodeValue, source.CodeValue, StringComparison.OrdinalIgnoreCase))
            {
                // Disallow PK column updates on DualCreditDescriptor
                throw new KeyChangeNotSupportedException("DualCreditDescriptor");
            }
        ...
        public static void MapTo(this IDualCreditDescriptor source, IDualCreditDescriptor target, Action<IDualCreditDescriptor, IDualCreditDescriptor> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (DualCreditDescriptorMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            // Copy contextual primary key values
            target.DualCreditDescriptorId = source.DualCreditDescriptorId;
...
namespace EdFi.Ods.Entities.Common.NE //.StudentDisciplineIncidentBehaviorAssociationAggregate
{
    ...
    public static class StudentDisciplineIncidentBehaviorAssociationExtensionMapper
    {
            ...
            if (mappingContract?.IsStudentDisciplineIncidentBehaviorAssociationWeaponsSupported ?? true)
            {
                isModified |=
                    source.StudentDisciplineIncidentBehaviorAssociationWeapons.SynchronizeCollectionTo(
                        ...
                        onChildAdded: child =>
                            {
                                child.StudentDisciplineIncidentBehaviorAssociationExtension = target;

                                // Extension class "children" need to reference the Ed-Fi Standard entity as the parent
                                (child as IChildEntity)?.SetParent(target.StudentDisciplineIncidentBehaviorAssociation);
                            },
        ...
        public static void MapTo(this IStudentDisciplineIncidentBehaviorAssociationExtension source, IStudentDisciplineIncidentBehaviorAssociationExtension target, Action<IStudentDisciplineIncidentBehaviorAssociationExtension, IStudentDisciplineIncidentBehaviorAssociationExtension> onMapped)
        {
            ...
            {
                source.StudentDisciplineIncidentBehaviorAssociationWeapons.MapCollectionTo(target.StudentDisciplineIncidentBehaviorAssociationWeapons, mappingContract?.IsStudentDisciplineIncidentBehaviorAssociationWeaponsItemCreatable ?? true, target.StudentDisciplineIncidentBehaviorAssociation, mappingContract?.IsStudentDisciplineIncidentBehaviorAssociationWeaponIncluded);
            }
    ...
    {
        private static readonly FullName _fullName_ne_StudentDisciplineIncidentBehaviorAssociationWeapon = new FullName("ne", "StudentDisciplineIncidentBehaviorAssociationWeapon");
        ...
        public static bool SynchronizeTo(this IStudentDisciplineIncidentBehaviorAssociationWeapon source, IStudentDisciplineIncidentBehaviorAssociationWeapon target)
        {
            ...
            var mappingContract = (StudentDisciplineIncidentBehaviorAssociationWeaponMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_StudentDisciplineIncidentBehaviorAssociationWeapon);
...
namespace EdFi.Ods.Entities.Common.NE //.StudentEducationOrganizationAssociationAggregate
{
    ...
    public static class StudentEducationOrganizationAssociationExtensionMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentEducationOrganizationAssociationExtension source, IStudentEducationOrganizationAssociationExtension target)
        {
            ...
            // Sync lists
            if (mappingContract?.IsStudentEducationOrganizationAssociationStudentCrisisEventsSupported ?? true)
            {
                isModified |=
                    source.StudentEducationOrganizationAssociationStudentCrisisEvents.SynchronizeCollectionTo(
                        target.StudentEducationOrganizationAssociationStudentCrisisEvents,
                        onChildAdded: child =>
                            {
                                child.StudentEducationOrganizationAssociationExtension = target;

                                // Extension class "children" need to reference the Ed-Fi Standard entity as the parent
                                (child as IChildEntity)?.SetParent(target.StudentEducationOrganizationAssociation);
                            },
                        itemCreatable: mappingContract?.IsStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable ?? true,
                        includeItem: item => mappingContract?.IsStudentEducationOrganizationAssociationStudentCrisisEventIncluded?.Invoke(item) ?? true);
            }
        ...
        public static void MapTo(this IStudentEducationOrganizationAssociationExtension source, IStudentEducationOrganizationAssociationExtension target, Action<IStudentEducationOrganizationAssociationExtension, IStudentEducationOrganizationAssociationExtension> onMapped)
        {
            ...
            if (mappingContract?.IsStudentEducationOrganizationAssociationStudentCrisisEventsSupported != false)
            {
                source.StudentEducationOrganizationAssociationStudentCrisisEvents.MapCollectionTo(target.StudentEducationOrganizationAssociationStudentCrisisEvents, mappingContract?.IsStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable ?? true, target.StudentEducationOrganizationAssociation, mappingContract?.IsStudentEducationOrganizationAssociationStudentCrisisEventIncluded);
            }
    ...
    [ExcludeFromCodeCoverage]
    public static class StudentEducationOrganizationAssociationStudentCrisisEventMapper
    {
        private static readonly FullName _fullName_ne_StudentEducationOrganizationAssociationStudentCrisisEvent = new FullName("ne", "StudentEducationOrganizationAssociationStudentCrisisEvent");
    
        public static bool SynchronizeTo(this IStudentEducationOrganizationAssociationStudentCrisisEvent source, IStudentEducationOrganizationAssociationStudentCrisisEvent target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (StudentEducationOrganizationAssociationStudentCrisisEventMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_StudentEducationOrganizationAssociationStudentCrisisEvent);


            // Copy non-PK properties

            if ((mappingContract?.IsDisplacedStudentIndicatorSupported != false)
                && target.DisplacedStudentIndicator != source.DisplacedStudentIndicator)
            {
                target.DisplacedStudentIndicator = source.DisplacedStudentIndicator;
                isModified = true;
            }
        ...
        public static void MapTo(this IStudentEducationOrganizationAssociationStudentCrisisEvent source, IStudentEducationOrganizationAssociationStudentCrisisEvent target, Action<IStudentEducationOrganizationAssociationStudentCrisisEvent, IStudentEducationOrganizationAssociationStudentCrisisEvent> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (StudentEducationOrganizationAssociationStudentCrisisEventMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
...
namespace EdFi.Ods.Entities.Common.NE //.StudentSectionAssociationAggregate
{
    [ExcludeFromCodeCoverage]
    public static class StudentSectionAssociationExtensionMapper
    {
        private static readonly FullName _fullName_ne_StudentSectionAssociationExtension = new FullName("ne", "StudentSectionAssociationExtension");
        ...
        public static bool SynchronizeTo(this IStudentSectionAssociationExtension source, IStudentSectionAssociationExtension target)
        {
            ...
            var mappingContract = (StudentSectionAssociationExtensionMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_ne_StudentSectionAssociationExtension);


            // Copy non-PK properties

            if ((mappingContract?.IsDualCreditDescriptorSupported != false)
                && target.DualCreditDescriptor != source.DualCreditDescriptor)
            {
                target.DualCreditDescriptor = source.DualCreditDescriptor;
                isModified = true;
            }
