...
namespace EdFi.Ods.Entities.Common.NE
{
    ...
    /// <summary>
    /// Defines available properties and methods for the abstraction of the CrisisDetails model.
    /// </summary>
    public interface ICrisisDetails : ISynchronizable, IMappable, IHasIdentifier, IGetByExample
    {
        // Primary Key properties
        
        string CrisisEventDescriptor { get; set; }

        // Non-PK properties
        string CrisisDesription { get; set; }
        DateTime CrisisStartDate { get; set; }
        string CrisisTypeDescriptor { get; set; }
    ...
    /// between entities/resources during API request processing.
    /// </summary>
    public class CrisisDetailsMappingContract : IMappingContract
    {
        public CrisisDetailsMappingContract(
            bool isCrisisDesriptionSupported,
            bool isCrisisStartDateSupported,
            bool isCrisisTypeDescriptorSupported
            )
        {
            IsCrisisDesriptionSupported = isCrisisDesriptionSupported;
            IsCrisisStartDateSupported = isCrisisStartDateSupported;
            IsCrisisTypeDescriptorSupported = isCrisisTypeDescriptorSupported;
        }

        public bool IsCrisisDesriptionSupported { get; }
        public bool IsCrisisStartDateSupported { get; }
        public bool IsCrisisTypeDescriptorSupported { get; }

        bool IMappingContract.IsMemberSupported(string memberName)
        {
            switch (memberName)
            {
                case "CrisisDesription":
                    return IsCrisisDesriptionSupported;
                case "CrisisStartDate":
                    return IsCrisisStartDateSupported;
                case "CrisisTypeDescriptor":
                    return IsCrisisTypeDescriptorSupported;
                // Additional inspection support for identifying properties (which are implicitly supported by Profiles) for use during validation
                case "CrisisEventDescriptor":
                    return true;
                default:
                    throw new Exception($"Unknown member '{memberName}'.");
            }
    ...
    /// <summary>
    /// Defines available properties and methods for the abstraction of the CrisisEventDescriptor model.
    /// </summary>
    public interface ICrisisEventDescriptor : EdFi.IDescriptor, ISynchronizable, IMappable, IHasIdentifier, IGetByExample
    {
        // Primary Key properties
        [AutoIncrement]
        int CrisisEventDescriptorId { get; set; }
    ...
    /// between entities/resources during API request processing.
    /// </summary>
    public class CrisisEventDescriptorMappingContract : IMappingContract
    {
        public CrisisEventDescriptorMappingContract(
    ...
    public interface ICrisisTypeDescriptor : EdFi.IDescriptor, ISynchronizable, IMappable, IHasIdentifier, IGetByExample
    {
        // Primary Key properties
        [AutoIncrement]
        int CrisisTypeDescriptorId { get; set; }
    ...
    /// between entities/resources during API request processing.
    /// </summary>
    public class CrisisTypeDescriptorMappingContract : IMappingContract
    {
        public CrisisTypeDescriptorMappingContract(
            bool isCodeValueSupported,
            bool isDescriptionSupported,
            bool isEffectiveBeginDateSupported,
            bool isEffectiveEndDateSupported,
    ...
    /// <summary>
    /// Defines available properties and methods for the abstraction of the DualCreditDescriptor model.
    /// </summary>
    public interface IDualCreditDescriptor : EdFi.IDescriptor, ISynchronizable, IMappable, IHasIdentifier, IGetByExample
    {
        // Primary Key properties
        [AutoIncrement]
        int DualCreditDescriptorId { get; set; }
    ...
    /// between entities/resources during API request processing.
    /// </summary>
    public class DualCreditDescriptorMappingContract : IMappingContract
    {
        public DualCreditDescriptorMappingContract(
            bool isCodeValueSupported,
            bool isDescriptionSupported,
            bool isEffectiveBeginDateSupported,
            bool isEffectiveEndDateSupported,
    ...
    /// </summary>
    public interface IStudentDisciplineIncidentBehaviorAssociationWeapon : ISynchronizable, IMappable, IGetByExample
    {
        // Primary Key properties
        IStudentDisciplineIncidentBehaviorAssociationExtension StudentDisciplineIncidentBehaviorAssociationExtension { get; set; }
    ...
    /// between entities/resources during API request processing.
    /// </summary>
    public class StudentDisciplineIncidentBehaviorAssociationWeaponMappingContract : IMappingContract
    {
    ...
    public interface IStudentEducationOrganizationAssociationExtension : ISynchronizable, IMappable, IGetByExample
    {
        ...
        // Lists
        ICollection<IStudentEducationOrganizationAssociationStudentCrisisEvent> StudentEducationOrganizationAssociationStudentCrisisEvents { get; set; }
    ...
    public class StudentEducationOrganizationAssociationExtensionMappingContract : IMappingContract
    {
        public StudentEducationOrganizationAssociationExtensionMappingContract(
            ...
            bool isStudentEducationOrganizationAssociationStudentCrisisEventsSupported,
            bool isStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable,
            Func<IStudentEducationOrganizationAssociationStudentCrisisEvent, bool> isStudentEducationOrganizationAssociationStudentCrisisEventIncluded
            )
        {
            IsImmigrantIndicatorDescriptorSupported = isImmigrantIndicatorDescriptorSupported;
            IsStudentEducationOrganizationAssociationStudentCrisisEventsSupported = isStudentEducationOrganizationAssociationStudentCrisisEventsSupported;
            IsStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable = isStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable;
            IsStudentEducationOrganizationAssociationStudentCrisisEventIncluded = isStudentEducationOrganizationAssociationStudentCrisisEventIncluded;
        }

        public bool IsImmigrantIndicatorDescriptorSupported { get; }
        public bool IsStudentEducationOrganizationAssociationStudentCrisisEventsSupported { get; }
        public bool IsStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable { get; }
        public Func<IStudentEducationOrganizationAssociationStudentCrisisEvent, bool> IsStudentEducationOrganizationAssociationStudentCrisisEventIncluded { get; }
        ...
        bool IMappingContract.IsMemberSupported(string memberName)
        {
            switch (memberName)
            {
                ...
                case "StudentEducationOrganizationAssociationStudentCrisisEvents":
                    return IsStudentEducationOrganizationAssociationStudentCrisisEventsSupported;
                // Additional inspection support for identifying properties (which are implicitly supported by Profiles) for use during validation
                default:
                    throw new Exception($"Unknown member '{memberName}'.");
            }
        ...
        bool IMappingContract.IsItemCreatable(string memberName)
        {
            ...
            {
                case "StudentEducationOrganizationAssociationStudentCrisisEvents":
                    return IsStudentEducationOrganizationAssociationStudentCrisisEventsItemCreatable;
                default:
                    throw new Exception($"Unknown child item '{memberName}'.");
            }
        }
    ...
    /// <summary>
    /// Defines available properties and methods for the abstraction of the StudentEducationOrganizationAssociationStudentCrisisEvent model.
    /// </summary>
    public interface IStudentEducationOrganizationAssociationStudentCrisisEvent : ISynchronizable, IMappable, IGetByExample
    {
        // Primary Key properties
        IStudentEducationOrganizationAssociationExtension StudentEducationOrganizationAssociationExtension { get; set; }
        
        string CrisisEventDescriptor { get; set; }

        // Non-PK properties
        bool DisplacedStudentIndicator { get; set; }
    ...
    /// between entities/resources during API request processing.
    /// </summary>
    public class StudentEducationOrganizationAssociationStudentCrisisEventMappingContract : IMappingContract
    {
        public StudentEducationOrganizationAssociationStudentCrisisEventMappingContract(
            bool isDisplacedStudentIndicatorSupported
            )
        {
            IsDisplacedStudentIndicatorSupported = isDisplacedStudentIndicatorSupported;
        }

        public bool IsDisplacedStudentIndicatorSupported { get; }

        bool IMappingContract.IsMemberSupported(string memberName)
        {
            switch (memberName)
            {
                case "DisplacedStudentIndicator":
                    return IsDisplacedStudentIndicatorSupported;
                // Additional inspection support for identifying properties (which are implicitly supported by Profiles) for use during validation
                case "CrisisEventDescriptor":
                    return true;
                default:
    ...
    public interface IStudentSchoolAssociationExtension : ISynchronizable, IMappable, IGetByExample
    {
        ...
        // Non-PK properties
        int? ExpectedHighSchoolOfGraduationSchoolId { get; set; }
        int ReportingSchoolId { get; set; }
        int ResidentLocalEducationAgencyId { get; set; }
        int? ResidentSchoolId { get; set; }
    ...
    public interface IStudentSectionAssociationExtension : ISynchronizable, IMappable, IGetByExample
    {
        ...
        // Non-PK properties
        string DualCreditDescriptor { get; set; }
    ...
    public class StudentSectionAssociationExtensionMappingContract : IMappingContract
    {
        public StudentSectionAssociationExtensionMappingContract(
            bool isDualCreditDescriptorSupported
            )
        {
            IsDualCreditDescriptorSupported = isDualCreditDescriptorSupported;
        }

        public bool IsDualCreditDescriptorSupported { get; }

        bool IMappingContract.IsMemberSupported(string memberName)
        {
            switch (memberName)
            {
                case "DualCreditDescriptor":
                    return IsDualCreditDescriptorSupported;
                // Additional inspection support for identifying properties (which are implicitly supported by Profiles) for use during validation
                default:
                    throw new Exception($"Unknown member '{memberName}'.");
            }
