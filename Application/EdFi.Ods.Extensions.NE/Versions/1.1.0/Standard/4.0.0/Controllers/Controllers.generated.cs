...
namespace EdFi.Ods.Api.Services.Controllers.NE.CrisisDetails
{
    [ApiExplorerSettings(IgnoreApi = true)]
    [ExcludeFromCodeCoverage]
    [ApiController]
    [Authorize]
    [ApplyOdsRouteRootTemplate, Route($"{RouteConstants.DataManagementRoutePrefix}/ne/crisisDetails")]
    public partial class CrisisDetailsController : DataManagementControllerBase<
        Api.Common.Models.Resources.CrisisDetails.NE.CrisisDetails,
        Entities.Common.NE.ICrisisDetails,
        Entities.NHibernate.CrisisDetailsAggregate.NE.CrisisDetails,
        Api.Common.Models.Requests.NE.CrisisDetails.CrisisDetailsPut,
        Api.Common.Models.Requests.NE.CrisisDetails.CrisisDetailsPost,
        Api.Common.Models.Requests.NE.CrisisDetails.CrisisDetailsDelete,
        Api.Common.Models.Requests.NE.CrisisDetails.CrisisDetailsGetByExample>
    {
        public CrisisDetailsController(IPipelineFactory pipelineFactory, IEdFiProblemDetailsProvider problemDetailsProvider, IDefaultPageSizeLimitProvider defaultPageSizeLimitProvider, ApiSettings apiSettings, IContextProvider<ProfileContentTypeContext> profileContentTypeContextProvider, IContextProvider<DataManagementResourceContext> dataManagementResourceContextProvider, ILogContextAccessor logContextAccessor)
        ...
        protected override void MapAll(Api.Common.Models.Requests.NE.CrisisDetails.CrisisDetailsGetByExample request, Entities.Common.NE.ICrisisDetails specification)
        {
            // Copy all existing values
            specification.SuspendReferenceAssignmentCheck();
            specification.CrisisDesription = request.CrisisDesription;
            specification.CrisisEventDescriptor = request.CrisisEventDescriptor;
            specification.CrisisStartDate = request.CrisisStartDate;
            specification.CrisisTypeDescriptor = request.CrisisTypeDescriptor;
            specification.Id = request.Id;
        }
    }
}

namespace EdFi.Ods.Api.Services.Controllers.NE.CrisisEventDescriptors
{
    [ApiExplorerSettings(IgnoreApi = true)]
    [ExcludeFromCodeCoverage]
    [ApiController]
    [Authorize]
    [ApplyOdsRouteRootTemplate, Route($"{RouteConstants.DataManagementRoutePrefix}/ne/crisisEventDescriptors")]
    public partial class CrisisEventDescriptorsController : DataManagementControllerBase<
        Api.Common.Models.Resources.CrisisEventDescriptor.NE.CrisisEventDescriptor,
        Entities.Common.NE.ICrisisEventDescriptor,
        Entities.NHibernate.CrisisEventDescriptorAggregate.NE.CrisisEventDescriptor,
        Api.Common.Models.Requests.NE.CrisisEventDescriptors.CrisisEventDescriptorPut,
        Api.Common.Models.Requests.NE.CrisisEventDescriptors.CrisisEventDescriptorPost,
        Api.Common.Models.Requests.NE.CrisisEventDescriptors.CrisisEventDescriptorDelete,
        Api.Common.Models.Requests.NE.CrisisEventDescriptors.CrisisEventDescriptorGetByExample>
    {
        public CrisisEventDescriptorsController(IPipelineFactory pipelineFactory, IEdFiProblemDetailsProvider problemDetailsProvider, IDefaultPageSizeLimitProvider defaultPageSizeLimitProvider, ApiSettings apiSettings, IContextProvider<ProfileContentTypeContext> profileContentTypeContextProvider, IContextProvider<DataManagementResourceContext> dataManagementResourceContextProvider, ILogContextAccessor logContextAccessor)
            : base(pipelineFactory, problemDetailsProvider, defaultPageSizeLimitProvider, apiSettings, profileContentTypeContextProvider, dataManagementResourceContextProvider, logContextAccessor)
        {
        }

        protected override void MapAll(Api.Common.Models.Requests.NE.CrisisEventDescriptors.CrisisEventDescriptorGetByExample request, Entities.Common.NE.ICrisisEventDescriptor specification)
        {
            // Copy all existing values
            specification.SuspendReferenceAssignmentCheck();
            specification.CodeValue = request.CodeValue;
            specification.CrisisEventDescriptorId = request.CrisisEventDescriptorId;
            specification.Id = request.Id;
...
namespace EdFi.Ods.Api.Services.Controllers.NE.CrisisTypeDescriptors
{
    [ApiExplorerSettings(IgnoreApi = true)]
    [ExcludeFromCodeCoverage]
    [ApiController]
    [Authorize]
    [ApplyOdsRouteRootTemplate, Route($"{RouteConstants.DataManagementRoutePrefix}/ne/crisisTypeDescriptors")]
    public partial class CrisisTypeDescriptorsController : DataManagementControllerBase<
        Api.Common.Models.Resources.CrisisTypeDescriptor.NE.CrisisTypeDescriptor,
        Entities.Common.NE.ICrisisTypeDescriptor,
        Entities.NHibernate.CrisisTypeDescriptorAggregate.NE.CrisisTypeDescriptor,
        Api.Common.Models.Requests.NE.CrisisTypeDescriptors.CrisisTypeDescriptorPut,
        Api.Common.Models.Requests.NE.CrisisTypeDescriptors.CrisisTypeDescriptorPost,
        Api.Common.Models.Requests.NE.CrisisTypeDescriptors.CrisisTypeDescriptorDelete,
        Api.Common.Models.Requests.NE.CrisisTypeDescriptors.CrisisTypeDescriptorGetByExample>
    {
        public CrisisTypeDescriptorsController(IPipelineFactory pipelineFactory, IEdFiProblemDetailsProvider problemDetailsProvider, IDefaultPageSizeLimitProvider defaultPageSizeLimitProvider, ApiSettings apiSettings, IContextProvider<ProfileContentTypeContext> profileContentTypeContextProvider, IContextProvider<DataManagementResourceContext> dataManagementResourceContextProvider, ILogContextAccessor logContextAccessor)
            : base(pipelineFactory, problemDetailsProvider, defaultPageSizeLimitProvider, apiSettings, profileContentTypeContextProvider, dataManagementResourceContextProvider, logContextAccessor)
        {
        }

        protected override void MapAll(Api.Common.Models.Requests.NE.CrisisTypeDescriptors.CrisisTypeDescriptorGetByExample request, Entities.Common.NE.ICrisisTypeDescriptor specification)
        {
            // Copy all existing values
            specification.SuspendReferenceAssignmentCheck();
            specification.CodeValue = request.CodeValue;
            specification.CrisisTypeDescriptorId = request.CrisisTypeDescriptorId;
            specification.Id = request.Id;
            specification.Namespace = request.Namespace;
        }
    }
...
namespace EdFi.Ods.Api.Services.Controllers.NE.DualCreditDescriptors
{
    [ApiExplorerSettings(IgnoreApi = true)]
    [ExcludeFromCodeCoverage]
    [ApiController]
    [Authorize]
    [ApplyOdsRouteRootTemplate, Route($"{RouteConstants.DataManagementRoutePrefix}/ne/dualCreditDescriptors")]
    public partial class DualCreditDescriptorsController : DataManagementControllerBase<
        Api.Common.Models.Resources.DualCreditDescriptor.NE.DualCreditDescriptor,
        Entities.Common.NE.IDualCreditDescriptor,
        Entities.NHibernate.DualCreditDescriptorAggregate.NE.DualCreditDescriptor,
        Api.Common.Models.Requests.NE.DualCreditDescriptors.DualCreditDescriptorPut,
        Api.Common.Models.Requests.NE.DualCreditDescriptors.DualCreditDescriptorPost,
        Api.Common.Models.Requests.NE.DualCreditDescriptors.DualCreditDescriptorDelete,
        Api.Common.Models.Requests.NE.DualCreditDescriptors.DualCreditDescriptorGetByExample>
    {
        public DualCreditDescriptorsController(IPipelineFactory pipelineFactory, IEdFiProblemDetailsProvider problemDetailsProvider, IDefaultPageSizeLimitProvider defaultPageSizeLimitProvider, ApiSettings apiSettings, IContextProvider<ProfileContentTypeContext> profileContentTypeContextProvider, IContextProvider<DataManagementResourceContext> dataManagementResourceContextProvider, ILogContextAccessor logContextAccessor)
            : base(pipelineFactory, problemDetailsProvider, defaultPageSizeLimitProvider, apiSettings, profileContentTypeContextProvider, dataManagementResourceContextProvider, logContextAccessor)
        {
        }

        protected override void MapAll(Api.Common.Models.Requests.NE.DualCreditDescriptors.DualCreditDescriptorGetByExample request, Entities.Common.NE.IDualCreditDescriptor specification)
        {
            // Copy all existing values
            specification.SuspendReferenceAssignmentCheck();
            specification.CodeValue = request.CodeValue;
            specification.DualCreditDescriptorId = request.DualCreditDescriptorId;
            specification.Id = request.Id;
            specification.Namespace = request.Namespace;
        }
    }
