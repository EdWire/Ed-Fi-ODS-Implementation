...
ALTER TABLE ne.PartCTransitionDelayReasonDescriptor ADD CONSTRAINT FK_f0ae8e_Descriptor FOREIGN KEY (PartCTransitionDelayReasonDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
ALTER TABLE ne.StudentDisciplineIncidentBehaviorAssociationExtension ADD CONSTRAINT FK_720b00_StudentDisciplineIncidentBehaviorAssociation FOREIGN KEY (BehaviorDescriptorId, IncidentIdentifier, SchoolId, StudentUSI)
REFERENCES edfi.StudentDisciplineIncidentBehaviorAssociation (BehaviorDescriptorId, IncidentIdentifier, SchoolId, StudentUSI)
ON DELETE CASCADE
;

ALTER TABLE ne.StudentDisciplineIncidentBehaviorAssociationWeapon ADD CONSTRAINT FK_459d56_StudentDisciplineIncidentBehaviorAssociation FOREIGN KEY (BehaviorDescriptorId, IncidentIdentifier, SchoolId, StudentUSI)
REFERENCES edfi.StudentDisciplineIncidentBehaviorAssociation (BehaviorDescriptorId, IncidentIdentifier, SchoolId, StudentUSI)
ON DELETE CASCADE
;

CREATE INDEX FK_459d56_StudentDisciplineIncidentBehaviorAssociation
...
ALTER TABLE ne.StudentDisciplineIncidentBehaviorAssociationWeapon ADD CONSTRAINT FK_459d56_WeaponDescriptor FOREIGN KEY (WeaponDescriptorId)
...
ALTER TABLE ne.StudentSchoolAssociationExtension ADD CONSTRAINT FK_880cb1_School2 FOREIGN KEY (ExpectedHighSchoolOfGraduationSchoolId)
REFERENCES edfi.School (SchoolId)
;

CREATE INDEX FK_880cb1_School2
...
ALTER TABLE ne.StudentSpecialEducationProgramAssociationExtension ADD CONSTRAINT FK_3da84f_PartCTransitionDelayReasonDescriptor FOREIGN KEY (PartCTransitionDelayReasonDescriptorId)
REFERENCES ne.PartCTransitionDelayReasonDescriptor (PartCTransitionDelayReasonDescriptorId)
;

CREATE INDEX FK_3da84f_PartCTransitionDelayReasonDescriptor
