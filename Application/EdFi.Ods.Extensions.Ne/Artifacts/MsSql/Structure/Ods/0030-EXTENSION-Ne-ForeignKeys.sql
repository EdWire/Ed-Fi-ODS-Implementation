...
ALTER TABLE [ne].[PartCTransitionDelayReasonDescriptor] WITH CHECK ADD CONSTRAINT [FK_PartCTransitionDelayReasonDescriptor_Descriptor] FOREIGN KEY ([PartCTransitionDelayReasonDescriptorId])
REFERENCES [edfi].[Descriptor] ([DescriptorId])
ON DELETE CASCADE
GO
...
ALTER TABLE [ne].[StudentDisciplineIncidentBehaviorAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentDisciplineIncidentBehaviorAssociationExtension_StudentDisciplineIncidentBehaviorAssociation] FOREIGN KEY ([BehaviorDescriptorId], [IncidentIdentifier], [SchoolId], [StudentUSI])
REFERENCES [edfi].[StudentDisciplineIncidentBehaviorAssociation] ([BehaviorDescriptorId], [IncidentIdentifier], [SchoolId], [StudentUSI])
ON DELETE CASCADE
GO

ALTER TABLE [ne].[StudentDisciplineIncidentBehaviorAssociationWeapon] WITH CHECK ADD CONSTRAINT [FK_StudentDisciplineIncidentBehaviorAssociationWeapon_StudentDisciplineIncidentBehaviorAssociation] FOREIGN KEY ([BehaviorDescriptorId], [IncidentIdentifier], [SchoolId], [StudentUSI])
REFERENCES [edfi].[StudentDisciplineIncidentBehaviorAssociation] ([BehaviorDescriptorId], [IncidentIdentifier], [SchoolId], [StudentUSI])
ON DELETE CASCADE
GO

CREATE NONCLUSTERED INDEX [FK_StudentDisciplineIncidentBehaviorAssociationWeapon_StudentDisciplineIncidentBehaviorAssociation]
ON [ne].[StudentDisciplineIncidentBehaviorAssociationWeapon] ([BehaviorDescriptorId] ASC, [IncidentIdentifier] ASC, [SchoolId] ASC, [StudentUSI] ASC)
GO

ALTER TABLE [ne].[StudentDisciplineIncidentBehaviorAssociationWeapon] WITH CHECK ADD CONSTRAINT [FK_StudentDisciplineIncidentBehaviorAssociationWeapon_WeaponDescriptor] FOREIGN KEY ([WeaponDescriptorId])
...
ON [ne].[StudentDisciplineIncidentBehaviorAssociationWeapon] ([WeaponDescriptorId] ASC)
GO
...
ALTER TABLE [ne].[StudentSchoolAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentSchoolAssociationExtension_School2] FOREIGN KEY ([ExpectedHighSchoolOfGraduationSchoolId])
REFERENCES [edfi].[School] ([SchoolId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentSchoolAssociationExtension_School2]
ON [ne].[StudentSchoolAssociationExtension] ([ExpectedHighSchoolOfGraduationSchoolId] ASC)
GO
...
ALTER TABLE [ne].[StudentSpecialEducationProgramAssociationExtension] WITH CHECK ADD CONSTRAINT [FK_StudentSpecialEducationProgramAssociationExtension_PartCTransitionDelayReasonDescriptor] FOREIGN KEY ([PartCTransitionDelayReasonDescriptorId])
REFERENCES [ne].[PartCTransitionDelayReasonDescriptor] ([PartCTransitionDelayReasonDescriptorId])
GO

CREATE NONCLUSTERED INDEX [FK_StudentSpecialEducationProgramAssociationExtension_PartCTransitionDelayReasonDescriptor]
ON [ne].[StudentSpecialEducationProgramAssociationExtension] ([PartCTransitionDelayReasonDescriptorId] ASC)
GO
