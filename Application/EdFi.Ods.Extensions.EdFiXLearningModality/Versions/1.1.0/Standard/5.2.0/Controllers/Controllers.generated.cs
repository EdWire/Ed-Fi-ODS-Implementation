...
namespace EdFi.Ods.Api.Services.Controllers.EdFiXLearningModality.ModalityTimeTypeDescriptors
{
    ...
    [ApiController]
    [Authorize]
    [ApplyOdsRouteRootTemplate, Route($"{RouteConstants.DataManagementRoutePrefix}/ed-fi-x-learning-modality/modalityTimeTypeDescriptors")]
...
namespace EdFi.Ods.Api.Services.Controllers.EdFiXLearningModality.ModalityTypeDescriptors
{
    ...
    [ApiController]
    [Authorize]
    [ApplyOdsRouteRootTemplate, Route($"{RouteConstants.DataManagementRoutePrefix}/ed-fi-x-learning-modality/modalityTypeDescriptors")]
