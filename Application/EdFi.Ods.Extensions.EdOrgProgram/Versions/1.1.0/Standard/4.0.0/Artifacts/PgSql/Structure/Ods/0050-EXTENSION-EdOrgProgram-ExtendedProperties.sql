...
COMMENT ON COLUMN edorgprogram.EducationOrganizationEducationOrganizationProgram.EducationOrganizationProgramProviderId IS 'Id for an entity that is administering edOrg level programs';
...
COMMENT ON COLUMN edorgprogram.EducationOrganizationProgramAuthorizedProvider.EducationOrganizationProgramProviderId IS 'Id for an entity that is administering edOrg level programs';
...
COMMENT ON COLUMN edorgprogram.EducationOrganizationProgramProvider.EducationOrganizationProgramProviderId IS 'Id for an entity that is administering edOrg level programs';
COMMENT ON COLUMN edorgprogram.EducationOrganizationProgramProvider.EducationOrganizationId IS 'The identifier assigned to an education organization.';
