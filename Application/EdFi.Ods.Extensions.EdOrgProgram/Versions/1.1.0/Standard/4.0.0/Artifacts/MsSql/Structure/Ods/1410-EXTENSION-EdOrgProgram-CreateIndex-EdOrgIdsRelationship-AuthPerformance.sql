...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_EducationOrganizationProgramProvider_EducationServiceCenterId' AND object_id = OBJECT_ID('edorgprogram.EducationOrganizationProgramProvider')) 
BEGIN
    CREATE INDEX IX_EducationOrganizationProgramProvider_EducationServiceCenterId ON [edorgprogram].[EducationOrganizationProgramProvider](EducationServiceCenterId) INCLUDE (Id)
END;
