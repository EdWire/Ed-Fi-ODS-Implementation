...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This entiy tracks what education organizations are getting edOrgPrograms.', @level0type=N'SCHEMA', @level0name=N'edorgprogram', @level1type=N'TABLE', @level1name=N'EducationOrganizationEducationOrganizationProgram'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Start date for the ed org program.', @level0type=N'SCHEMA', @level0name=N'edorgprogram', @level1type=N'TABLE', @level1name=N'EducationOrganizationEducationOrganizationProgram', @level2type=N'COLUMN', @level2name=N'BeginDate'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to an education organization.', @level0type=N'SCHEMA', @level0name=N'edorgprogram', @level1type=N'TABLE', @level1name=N'EducationOrganizationEducationOrganizationProgram', @level2type=N'COLUMN', @level2name=N'EducationOrganizationId'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'This entiy tracks what providers are authorized to administer education organization level programs.', @level0type=N'SCHEMA', @level0name=N'edorgprogram', @level1type=N'TABLE', @level1name=N'EducationOrganizationProgramAuthorizedProvider'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'Program types that are administered at the education organization level instead of the student level.', @level0type=N'SCHEMA', @level0name=N'edorgprogram', @level1type=N'TABLE', @level1name=N'EducationOrganizationProgramTypeDescriptor'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.', @level0type=N'SCHEMA', @level0name=N'edorgprogram', @level1type=N'TABLE', @level1name=N'EducationOrganizationProgramTypeDescriptor', @level2type=N'COLUMN', @level2name=N'EducationOrganizationProgramTypeDescriptorId'
GO
