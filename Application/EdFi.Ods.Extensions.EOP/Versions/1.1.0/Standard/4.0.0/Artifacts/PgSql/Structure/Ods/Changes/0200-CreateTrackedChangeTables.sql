...
IF NOT EXISTS (SELECT 1 FROM information_schema.schemata WHERE schema_name = 'tracked_changes_eop') THEN
CREATE SCHEMA tracked_changes_eop;
END IF;

IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'tracked_changes_eop' AND table_name = 'educationorganizationeducationorganizationprogram') THEN
...
IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'tracked_changes_eop' AND table_name = 'educationorganizationprogramauthorizedprovider') THEN
...
IF NOT EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'tracked_changes_eop' AND table_name = 'educationorganizationprogramprovider') THEN
