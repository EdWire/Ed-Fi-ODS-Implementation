...
GO
ALTER TABLE [edfixassessmentroster].[AssessmentAdministrationContact] ADD CONSTRAINT [AssessmentAdministrationContact_DF_CreateDate] DEFAULT (getutcdate()) FOR [CreateDate]
GO
