...
COMMENT ON COLUMN edfixassessmentroster.StudentAssessmentRegistration.EntryDate IS 'The month, day, and year on which an individual enters and begins to receive instructional services in a school.';
...
COMMENT ON COLUMN edfixassessmentroster.StudentAssessmentRegistration.SchoolId IS 'The identifier assigned to a school.';
