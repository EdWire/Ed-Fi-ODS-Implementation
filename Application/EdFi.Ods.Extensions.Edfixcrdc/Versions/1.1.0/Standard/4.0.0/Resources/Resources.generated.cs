...
namespace EdFi.Ods.Api.Common.Models.Resources.ClassGroup.Edfixcrdc
{
    ...
    public class ClassGroupReference : IResourceReference
    {
        ...
        {
            return ClassGroupName != default(string) && CommunityProviderId != default(int) && CommunityProviderLocationId != default(int) && SpecialNeedsProvidedIndicator != default(bool);
        }
...
#pragma warning restore 414
        ...
        int Entities.Common.Edfixcrdc.IClassGroup.CommunityProviderId
        {
            get
            {
                if (ImplicitCommunityProviderLocationReference != null
...
#pragma warning restore 414
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int Entities.Common.Edfixcrdc.IClassGroupCourse.EducationOrganizationId
        {
            get
            {
                if (ImplicitCourseReference != null
...
namespace EdFi.Ods.Api.Common.Models.Resources.CommunityProviderLocation.Edfixcrdc
{
    ...
    public class CommunityProviderLocationReference : IResourceReference
    {
        ...
        public bool IsReferenceFullyDefined()
        {
            return CommunityProviderId != default(int) && CommunityProviderLocationId != default(int);
        }
...
#pragma warning restore 414
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int Entities.Common.Edfixcrdc.ICommunityProviderLocation.CommunityProviderId
        {
            get
            {
                if (ImplicitCommunityProviderReference != null
        ...
        /// </summary>
        // NOT in a reference, NOT a lookup column 
        [NonDefaultStringLength(17, MinimumLength=1, ErrorMessage=ValidationHelpers.StringLengthWithMinimumMessageFormat), NoDangerousText]
...
namespace EdFi.Ods.Api.Common.Models.Resources.StudentClassGroupAssociation.Edfixcrdc
{
    ...
    public class StudentClassGroupAssociationReference : IResourceReference
    {
        ...
        public bool IsReferenceFullyDefined()
        {
            return BeginDate != default(DateTime) && ClassGroupName != default(string) && CommunityProviderId != default(int) && CommunityProviderLocationId != default(int) && SpecialNeedsProvidedIndicator != default(bool) && StudentUniqueId != default(string);
        }
...
#pragma warning restore 414
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int Entities.Common.Edfixcrdc.IStudentClassGroupAssociation.CommunityProviderId
        {
            get
            {
                if (ImplicitClassGroupReference != null
...
namespace EdFi.Ods.Api.Common.Models.Resources.StudentCommunityProviderLocationAssociation.Edfixcrdc
{
    ...
    public class StudentCommunityProviderLocationAssociationReference : IResourceReference
    {
        ...
        public bool IsReferenceFullyDefined()
        {
            return BeginDate != default(DateTime) && CommunityProviderId != default(int) && CommunityProviderLocationId != default(int) && StudentUniqueId != default(string);
        }
...
#pragma warning restore 414
        ...
        /// </summary>
        // IS in a reference, NOT a lookup column 
        int Entities.Common.Edfixcrdc.IStudentCommunityProviderLocationAssociation.CommunityProviderId
        {
            get
            {
                if (ImplicitCommunityProviderLocationReference != null
