DROP TRIGGER IF EXISTS [edfixcrdc].[edfixcrdc_ClassGroup_TR_UpdateChangeVersion]
GO
...
DROP TRIGGER IF EXISTS [edfixcrdc].[edfixcrdc_CommunityProviderLocation_TR_UpdateChangeVersion]
GO
...
DROP TRIGGER IF EXISTS [edfixcrdc].[edfixcrdc_StudentClassGroupAssociation_TR_UpdateChangeVersion]
GO
...
DROP TRIGGER IF EXISTS [edfixcrdc].[edfixcrdc_StudentCommunityProviderLocationAssociation_TR_UpdateChangeVersion]
GO
