...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a community provider. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'ClassGroupCourse', @level2type=N'COLUMN', @level2name=N'CommunityProviderId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a community provider. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'CommunityProviderLocation', @level2type=N'COLUMN', @level2name=N'CommunityProviderId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a community provider. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'CommunityProviderLocationInstructionalCalendar', @level2type=N'COLUMN', @level2name=N'CommunityProviderId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a school. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'RestraintEventRestraintCategory', @level2type=N'COLUMN', @level2name=N'SchoolId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a school. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'SchoolExtension', @level2type=N'COLUMN', @level2name=N'SchoolId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a community provider. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'StudentClassGroupAssociation', @level2type=N'COLUMN', @level2name=N'CommunityProviderId'
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The identifier assigned to a community provider. It must be distinct from any other identifier assigned to educational organizations, such as a LocalEducationAgencyId, to prevent duplication.', @level0type=N'SCHEMA', @level0name=N'edfixcrdc', @level1type=N'TABLE', @level1name=N'StudentCommunityProviderLocationAssociation', @level2type=N'COLUMN', @level2name=N'CommunityProviderId'
GO
