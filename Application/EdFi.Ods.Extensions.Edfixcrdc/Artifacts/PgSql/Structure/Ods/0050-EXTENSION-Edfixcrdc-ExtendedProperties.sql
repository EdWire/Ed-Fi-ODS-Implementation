...
COMMENT ON COLUMN edfixcrdc.ClassGroup.CommunityProviderId IS 'The identifier assigned to a community provider.';
...
COMMENT ON COLUMN edfixcrdc.ClassGroupCourse.CommunityProviderId IS 'The identifier assigned to a community provider.';
...
COMMENT ON COLUMN edfixcrdc.ClassGroupMeetingTime.CommunityProviderId IS 'The identifier assigned to a community provider.';
...
COMMENT ON COLUMN edfixcrdc.CommunityProviderLocation.CommunityProviderId IS 'The identifier assigned to a community provider.';
...
COMMENT ON COLUMN edfixcrdc.CommunityProviderLocationInstructionalCalendar.CommunityProviderId IS 'The identifier assigned to a community provider.';
...
COMMENT ON COLUMN edfixcrdc.StudentClassGroupAssociation.CommunityProviderId IS 'The identifier assigned to a community provider.';
...
COMMENT ON COLUMN edfixcrdc.StudentCommunityProviderLocationAssociation.CommunityProviderId IS 'The identifier assigned to a community provider.';
