...
ALTER TABLE tpdm.ActionStepDescriptor ADD CONSTRAINT FK_790891_Descriptor FOREIGN KEY (ActionStepDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
...
CREATE INDEX FK_7ae19d_ActionStepDescriptor
ON tpdm.EvaluationObjectiveRating (CompletedActionStepDescriptorId ASC);

ALTER TABLE tpdm.EvaluationObjectiveRating ADD CONSTRAINT FK_7ae19d_ActionStepDescriptor1 FOREIGN KEY (NewActionStepDescriptorId)
REFERENCES tpdm.ActionStepDescriptor (ActionStepDescriptorId)
;

CREATE INDEX FK_7ae19d_ActionStepDescriptor1
...
ALTER TABLE tpdm.PerformanceEvaluationRating ADD CONSTRAINT FK_759abe_PerformanceEvaluationRatingTypeDescriptor FOREIGN KEY (PerformanceEvaluationRatingTypeDescriptorId)
REFERENCES tpdm.PerformanceEvaluationRatingTypeDescriptor (PerformanceEvaluationRatingTypeDescriptorId)
;

CREATE INDEX FK_759abe_PerformanceEvaluationRatingTypeDescriptor
...
ALTER TABLE tpdm.PerformanceEvaluationRatingTypeDescriptor ADD CONSTRAINT FK_0c99ae_Descriptor FOREIGN KEY (PerformanceEvaluationRatingTypeDescriptorId)
REFERENCES edfi.Descriptor (DescriptorId)
ON DELETE CASCADE
;
